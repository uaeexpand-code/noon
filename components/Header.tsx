    ...
    <header className="relative z-20 flex flex-wrap items-center justify-between gap-4 mb-4 sm:mb-6 p-4 rounded-xl bg-gray-800/60 backdrop-blur-xl shadow-lg border border-white/10 animate-fadeIn">
        ...
        <div className="flex items-center flex-grow justify-center space-x-2 sm:space-x-4">
            ...
            <div className="flex items-center">
                <button onClick={() => handleNavigation('prev')} className="p-2 text-gray-400 hover:text-white rounded-full hover:bg-gray-700/80 transition-all duration-200 transform hover:scale-110 active:scale-95" aria-label="Previous period">
                    <ChevronLeftIcon />
                </button>
                <h2 className="w-32 sm:w-48 text-center text-sm sm:text-xl font-semibold text-white">
                    {getTitle(currentDate, viewMode)}
                </h2>
                <button onClick={() => handleNavigation('next')} className="p-2 text-gray-400 hover:text-white rounded-full hover:bg-gray-700/80 transition-all duration-200 transform hover:scale-110 active:scale-95" aria-label="Next period">
                    <ChevronRightIcon />
                </button>
            </div>
        </div>
